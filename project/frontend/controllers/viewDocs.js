...
myApp.controller('DocViewController', function viewDocsController($scope,$http,$timeout,$sessionStorage,$localStorage) {
  ...
  var refresh= function(){
   ...
   var accessGroup=userAuthSessionJson.accessLevel;
  console.log("access ..."+accessGroup);


    $http.get('/fileUpload/'+accessGroup).success(function(response){
...
$scope.showAudioTag = function (file) {
